...
For a supernova located 10~kpc from the Earth (the galactic center is
approximately 8~kpc away) the order of 10,000 neutrino interactions are
...
We suggest attempting uniform depth in grizy in order to make sure
