...
to IMB and Kamiokande, Super-Kamiokande (\superk) await the neutrinos from a
...
experiment with pointing.  In the part way through the LSST 10 year
...
in the future also provide initial positions~\cite{Katepaper} but will
likely not produce as accurate an estimate as the signal from the
\superk experiment.

For this reason, here we concentrate on position estimates as provided
by \superk.  
