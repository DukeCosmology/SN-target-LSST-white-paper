...
$3^\circ$.  Closer supernovae will have higher numbers of interactions
...
0.02\% $\textrm Gd_2(SO_4)_3$~\cite{2018JCAP...04..025B}.  The addition of gadolinium
...
\end{itemize}
\item If CCSN candidates are identified, pass this information to community and event brokers
...
6 degrees FOV (twice the opening angle resolution).
...
for this work is its ability to see CCSN which have been obscured by
