...
\begin{abstract}
  ...
  located near the center of our galaxy.  A CCCN located 10~kpc from
  ...
  initial search box.  LSSTs depth is also uniquely suited for
...
complex phenomenology which is today not completely understood.
 ...
 (\superk)~\cite{2003NIMPA.501..418F} 1await the neutrinos from a galactic
...
supernova that fail to create a explosion~\cite{2011ApJ...730...70O}. Recent
...
black hole~\cite{2011ApJ...730...70O, 2017hsn..book.1555O} or the
supernova could be hidden in the dust of the galactic plane.  The
expected range of brightnesses are explored
in~\cite{2016MNRAS.461.3296N} and
