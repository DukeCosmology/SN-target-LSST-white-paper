...
\begin{figure}
  \begin{center}
    ...
    \caption{Figure 7 from~\cite{2016APh....81...39A} shows a
      simulated set of neutrino interactions from a particular model
      at 10~kpc from Earth in the equatorial coordinate system.  The
      blue points are the IBD events, the red the electron scattering
      events.  The reconstructed direction after fitting is shown with
      a star. See reference~\cite{2016APh....81...39A} for more
